            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <span className="absolute right-4 top-4" onClick={() => setPasswordToggle(!passwordToggle)} >
                    {
                      passwordToggle ? <CiLock size={25} /> : <CiUnlock size={25} />
                    }
                  </span>
                </div>
              </div>
              ...
              <div className="mb-5">
                ...
                <button className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90" onClick={handleSignIn}>Sign In</button>
              </div>
