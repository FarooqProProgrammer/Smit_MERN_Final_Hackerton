...
const SignUp: React.FC = () => {
  ...
  const handleSignup = async () => {
    await axios.post(`http://localhost:4000/register`, { email, password, Name:name }).then((res) => {
        console.log(res.data)
        toast.success('Data Submitt')
    })
  }
          ...
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <div>
              ...
              <div className="mb-5">
                ...
                <button onClick={handleSignup} className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90">Register</button>
              </div>
